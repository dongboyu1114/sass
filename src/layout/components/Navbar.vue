    ...
    <div class="right-menu">
      <el-dropdown class="avatar-container" trigger="click">
        ...
        <el-dropdown-menu slot="dropdown" class="user-dropdown">
          ...
          <a target="_blank" href="https://github.com/PanJiaChen/vue-admin-template/"><el-dropdown-item>项目地址</el-dropdown-item></a>
...
export default {
  ...
  data() {
    return { defaultImg: require('@/assets/common/head.jpg') }
  },
  computed: {
